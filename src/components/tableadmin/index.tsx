            ...
            <tbody>

                {
                    ...
                    data.map((object,key)=>(
                        ...
                        <td className="px-6 py-4">
                            <Link href="/editar/[id]" as={`/editar/${object.id}`} className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Editar</Link>
                        </td>
                        <td className="px-6 py-4">
                            <a href="" onClick={() => deleteNotify(object.id)} className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Excluir</a>
                        </td>
                    </tr>
                    ))
                    )
