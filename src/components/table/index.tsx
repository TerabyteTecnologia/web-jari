  ...
  const [filter, setFilter] = useState<string>('');
    ...
    const handleDownload = async () => {
        try {
          ...
          link.href = url;
          link.setAttribute('download', 'Notificacao.pdf');
        ...
        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
            {
                    ...
                    data.map((object,key)=>(
                        ...
                        <td className="px-6 py-4">
                            <a href={apiURL+'/public/'+object.pathfile} target='target_blank' className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Balixar</a>
                        </td>
